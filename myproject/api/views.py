...
# Add your XML parsing and polygon handling code here (from your previous example)
import xml.etree.ElementTree as ET
...
def get_polygons(request):
    # Replace the path with the correct path to your XML file
    xml_file = os.path.join(os.path.dirname(__file__), 'C:/Users/yasee/Downloads/705 Cordova Ln, Lenoir City, TN 37771, USA.xml')
    polygons = generate_pdf_polygons(xml_file)
